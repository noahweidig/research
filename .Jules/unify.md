...
## 2025-05-18 - Inaccurate Terminology for Diverse Content Types
**Learning:** Using overly specific academic terminology (like "Abstract") for non-academic content types (like "Media Coverage" or "Peer Reviews") creates confusion and breaks narrative cohesion. The same applies to UI elements like "Search publications" when the page contains more than just publications.
**Action:** When displaying diverse content types, use appropriately generic or dynamic terminology (e.g., "Summary" instead of "Abstract", "Search research and publications" instead of "Search publications", "Expand all" instead of "Expand all abstracts") to accurately reflect the content and maintain consistency.
